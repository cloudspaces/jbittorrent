...
public class
	...
	private void
        ...
        if (object instanceof String || object instanceof Float) {
            ...
            if (tempMap instanceof TreeMap) {
                ...
                tempTree = new TreeMap<Object,Object>(tempMap);
            }
	...
	private static boolean
        ...
        if (o1 instanceof Long) {
            ...
            return (listsAreIdentical((List<Object>) o1, (List<Object>) o2));

        } else if (o1 instanceof Map) {

            return (mapsAreIdentical((Map<Object,Object>) o1, (Map<Object,Object>) o2));
